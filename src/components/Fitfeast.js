...
export default class Fitteast extends Component {
  constructor(props) {
    super(props);
    this.state = {
      city: 'Delhi',
    ...
    let data = [
      {
        title: 'FITFEAST',
        description:
          'Get guaranteed results with real time assistance from expert nutrutionist',
        price: '1279',
        month: 1,
      },
      {
      ...
      <>
        <ScrollView style={{marginBottom: 50}}>
          ...
          <View style={{height: widthToDp(55)}}>
            <PriceSlider data={data} bg="#f95454" />
          </View>

          <View style={styles._detailSection}>
            <Text style={styles._title}>What is FITFEAST?</Text>

            <View style={styles._li}>
              <FontAwesome name="check" size={16} color={'#f95454'} />
              <Text style={styles.li_text}>Personal Nutritionist</Text>
            </View>

            <View style={styles._li}>
              <FontAwesome name="check" size={16} color={'#f95454'} />
              <Text style={styles.li_text}>Customised daily diets</Text>
            </View>

            <View style={styles._li}>
              <FontAwesome name="check" size={16} color={'#f95454'} />
              <Text style={styles.li_text}>Meal Log</Text>
            </View>

            <View style={styles._li}>
              <FontAwesome name="check" size={16} color={'#f95454'} />
              <Text style={styles.li_text}>Calorie Counter</Text>
            </View>

            <View style={styles._li}>
              <FontAwesome name="check" size={16} color={'#f95454'} />
              <Text style={styles.li_text}>Water Tracker</Text>
            </View>

            <Text
              style={styles._viewshop}
              onPress={() =>
                this.props.navigation.navigate('Nutritionist', {
                  city: this.state.city,
                  type: this.state.typ,
                })
              }>
              <Text style={{padding: 12}}>FITFEAST </Text>
